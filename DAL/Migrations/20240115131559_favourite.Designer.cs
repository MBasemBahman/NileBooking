...
namespace DAL.Migrations
{
    ...
    [Migration("20240115131559_favourite")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.DBModels.FavouriteModels.FavouriteAccountHotel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FavouriteAccountHotel");
                });
            ...
            modelBuilder.Entity("Entities.DBModels.UserModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastName = "Account",
                            Password = "$2a$11$oTEixDmd1cQLRWBDUiJbdey4qBTiRUql2N.LJGPNw31Xc0qyPh6mi",
                            UserName = "Developer"
                        });
                });
            ...
            modelBuilder.Entity("Entities.DBModels.FavouriteModels.FavouriteAccountHotel", b =>
                {
                    b.HasOne("Entities.DBModels.AccountModels.Account", "Account")
                        .WithMany("FavouriteAccountHotels")
                        .HasForeignKey("Fk_Account")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.DBModels.AccountModels.Account", b =>
                {
                    ...
                    b.Navigation("FavouriteAccountHotels");
                });
