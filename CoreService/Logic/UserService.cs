            ...
            bool trackChanges)
        {
            return _repository.User
                       ...
                       .Select(a => new UserModel
                       {
                           ...
                           LastName = a.LastName,
                           AppleToken= a.AppleToken,
                           Culture=a.Culture,
                           FacebookToken= a.FacebookToken,
                           GoogleToken= a.GoogleToken,
                           InstagramToken = a.InstagramToken,
                           IsExternalLogin = a.IsExternalLogin,
                           LinkedInToken = a.LinkedInToken,
                           OtherToken= a.OtherToken,
                           TwitterToken= a.TwitterToken,
                           UserName = a.UserName,
